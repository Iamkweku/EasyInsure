...
const insurancePlans = [
  {
    companyName: 'Acacia Health Insurance LTD',
    planName: 'SupercarePlus Plan',
    coverAmount: 'GH₵21k',
    premium: 'GH₵1.18k/month',
    image: require('../assets/Acacia.png'),
    policyScreen: 'AcaciaPolicyScreen',
  },
  {
    companyName: 'Baba Health Insurance LTD',
    planName: 'Family Care Plan',
    coverAmount: 'GH₵15k',
    premium: 'GH₵900/month',
    image: require('../assets/Acacia.png'),
    policyScreen: 'BabaPolicyScreen',
  },
  // ... more plans
];
